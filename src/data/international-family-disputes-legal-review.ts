...
export const INTERNATIONAL_FAMILY_DISPUTES_REVIEWED_AT = "2026-09-18";
export const INTERNATIONAL_FAMILY_DISPUTES_RULES: {
...
}[] = [
  {
    ...
    norm: "статьи 160, 163 и 164 СК РФ", officialSource: "Официальный интернет-портал правовой информации", url: "https://pravo.gov.ru/proxy/ips/?docbody=&nd=102038925",
  ...
  },
  {
    ...
    norm: "статья 402 ГПК РФ", officialSource: "Официальный интернет-портал правовой информации", url: "https://pravo.gov.ru/proxy/ips/?docbody=&nd=102078828",
  ...
  },
  {
    ...
    norm: "статьи 408 и 409, глава 45 ГПК РФ", officialSource: "Официальный интернет-портал правовой информации", url: "https://pravo.gov.ru/proxy/ips/?docbody=&nd=102078828",
    ...
    limitations: "Режим документа или решения определяется по государству происхождения, международному договору и цели использования; маршрут не подтверждает его автоматически."
  },
  {
