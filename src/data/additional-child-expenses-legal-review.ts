...
export const ADDITIONAL_CHILD_EXPENSES_REVIEWED_AT = "2026-09-15";
...
export const ADDITIONAL_CHILD_EXPENSES_LEGAL_RULES: AdditionalChildExpensesLegalRule[] = [
  { id: "sk-86", statement: "При отсутствии соглашения суд может привлечь родителя к дополнительным расходам только при исключительных обстоятельствах; учитываются материальное и семейное положение и иные заслуживающие внимания интересы.", norm: "статья 86 СК РФ", officialSource: "КонсультантПлюс, действующая консолидированная редакция (резервный источник)", url: "https://www.consultant.ru/document/cons_doc_LAW_8982/5e267c47e7ab0f1090e78ae91bd85809a7fcf791/", checkedAt: ADDITIONAL_CHILD_EXPENSES_REVIEWED_AT, scope: "Несовершеннолетние дети и нетрудоспособные совершеннолетние нуждающиеся дети; понесённые и необходимые будущие расходы.", scenarios: ["assessment", "agreement", "incurred", "future"], limitations: "Перечень обстоятельств открыт, но обычные расходы не становятся дополнительными автоматически." },
  ...
  { id: "sk-99-100", statement: "Соглашение об уплате алиментов определяет размер, условия и порядок выплат, заключается письменно и удостоверяется нотариально.", norm: "статьи 99–100 СК РФ", officialSource: "КонсультантПлюс, действующая консолидированная редакция (резервный источник)", url: "https://www.consultant.ru/document/cons_doc_LAW_8982/0260ce2eb7da30f7c9c000da28152f1b2531625e/", checkedAt: ADDITIONAL_CHILD_EXPENSES_REVIEWED_AT, scope: "Добровольный алиментный порядок; проект сервиса передаётся нотариусу.", scenarios: ["agreement"], legalPath: ["agreement"], limitations: "Проект не заменяет нотариально удостоверенное соглашение и не имеет силы исполнительного листа." },
