...
export const PARENTS_CHILD_DOCUMENTS: NavigatorDocument[] = [
  ...
  createDocument("change", "Изменение порядка по ребёнку", "Соглашение или судебный черновик", ["изменить график общения с ребёнком", "изменить место жительства ребёнка"]),
