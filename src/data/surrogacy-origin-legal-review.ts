...
export const SURROGACY_ORIGIN_REVIEWED_AT = "2026-09-17";
export const SURROGACY_ORIGIN_RULES: {
...
}[] = [
  {
    ...
    norm: "пункты 4–6 статьи 51 СК РФ", officialSource: "Официальный сайт Президента РФ, текст кодекса",
    url: "https://www.kremlin.ru/acts/bank/8671/print", checkedAt: SURROGACY_ORIGIN_REVIEWED_AT,
  ...
  },
  {
    ...
    norm: "части 9–11 статьи 55 Федерального закона № 323-ФЗ", officialSource: "Федеральный центр Минздрава России, опубликованный текст закона (копия 2025 года)",
    url: "https://fcmk.minzdrav.gov.ru/wp-content/uploads/2025/09/ob-osnovah-ohrany-zdorovya-grazhdan-v-rossijskoj-federaczii.pdf", checkedAt: SURROGACY_ORIGIN_REVIEWED_AT,
    scope: "Участники программы, медицинские согласия, гражданство.", scenarios: ["consents", "foreign", "registration"],
    legalPath: "Собирать даты и документы; не рассчитывать допустимость программы по устаревающей копии.",
    limitations: "Копия не подтверждает все поправки после 2025 года; автоматического вывода о допустимости программы нет."
  },
  {
    ...
    norm: "пункт 5 статьи 16 Федерального закона № 143-ФЗ", officialSource: "Официальный сайт Департамента ЗАГС Томской области, опубликованный текст закона",
    url: "https://zags.tomsk.gov.ru/documents/front/view/id/40276", checkedAt: SURROGACY_ORIGIN_REVIEWED_AT,
