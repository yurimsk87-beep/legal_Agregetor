...
const topProblemOverrides: Record<string, LegalProblemOverride> = {
  ...
  "semya-i-deti/brak-zags-i-smena-familii": {
    title: "Брак, ЗАГС и смена фамилии",
    h1: "Брак, ЗАГС и смена фамилии",
    shortTitle: "Брак, ЗАГС и фамилия",
    shortAnswer: "Эта страница — про регистрацию брака, смену фамилии (при вступлении в брак, после развода или по желанию) и другие действия в ЗАГС: получение свидетельств, исправление ошибок, восстановление документов.",
    description: "РЕГИСТРАЦИЯ БРАКА: подаётся совместное заявление в ЗАГС или через Госуслуги. Как правило, регистрируют через месяц после подачи заявления. При беременности, рождении ребёнка или угрозе жизни — в день обращения. Препятствия к браку: другой нерасторгнутый брак, близкое родство, усыновление между теми же лицами, недееспособность одного из будущих супругов. СМЕНА ФАМИЛИИ: при вступлении в брак — в ЗАГС при регистрации; при разводе — там же или отдельно в любое время; по желанию (не связано с браком) — через ЗАГС по месту жительства с последующей заменой паспорта, СНИЛС, ИНН, полиса ОМС и других документов. ВОССТАНОВЛЕНИЕ ДОКУМЕНТОВ: дубликат свидетельства выдаётся в ЗАГС по заявлению. Если запись утрачена — через суд об установлении юридического факта.",
    seoTitle: "Брак, ЗАГС и смена фамилии — регистрация, документы и порядок действий",
    seoDescription: "Как зарегистрировать брак, сменить фамилию после замужества или развода, восстановить свидетельство о браке и исправить ошибку в документах ЗАГС.",
    riskLevel: "low",
    urgency: "standard",
    heroNote: {
      title: "Какая страница вам нужна",
      text: "Если вы хотите расторгнуть брак — перейдите в [«Развод»](/problems/semya-i-deti/razvod). Если вопрос о разделе имущества — в [«Раздел имущества супругов»](/problems/semya-i-deti/razdel-imushchestva-suprugov). Если вопрос об условиях распределения имущества до/в браке — в [«Брачный договор»](/problems/semya-i-deti/brachnyy-dogovor)."
    },
    whatToKnow: [
      "Брак заключается в ЗАГС по взаимному добровольному согласию лиц, достигших 18 лет. С разрешения органа местного самоуправления — с 16 лет при наличии уважительных причин.",
      "Подать заявление на регистрацию брака можно через Госуслуги или лично в ЗАГС. Регистрация — через месяц после подачи. Срок может быть сокращён или увеличен при уважительных причинах.",
      "Нельзя вступить в брак при наличии другого нерасторгнутого брака, между близкими родственниками (родители-дети, братья-сёстры и т. д.), между усыновителем и усыновлённым, если одно из лиц признано недееспособным.",
      "При вступлении в брак каждый из супругов может: оставить свою фамилию, взять фамилию другого, взять двойную фамилию. Выбор фиксируется при регистрации.",
      "Смена фамилии после развода: можно вернуть добрачную фамилию при расторжении в ЗАГС или суде, либо сделать это позже через отдельное заявление в ЗАГС — в любое время после развода.",
      "Смена фамилии по желанию (без связи с браком): гражданин с 14 лет вправе изменить имя, фамилию или отчество через ЗАГС. После смены нужно заменить паспорт, СНИЛС, ИНН, медицинский полис, трудовую книжку (запись), банковские карты.",
      "Исправление ошибки в актовой записи: если ЗАГС допустил ошибку при регистрации — исправляется по заявлению. Если исправление затрагивает права третьих лиц — через суд.",
      "Дубликат свидетельства о браке, рождении, расторжении брака выдаётся в ЗАГС, который делал исходную запись, или через МФЦ/Госуслуги."
    ],
    deadlines: [
      "Регистрация брака — через 1 месяц после подачи заявления (срок может быть изменён).",
      "После регистрации брака — замена паспорта в течение 30 дней (иначе штраф).",
      "После смены фамилии — замена паспорта в течение 30 дней.",
      "Дубликат свидетельства — выдаётся в день обращения или в течение 30 дней, если запись хранится в другом регионе."
    ],
    risks: [
      "При несвоевременной замене паспорта после смены фамилии — административный штраф.",
      "Если не заменить все документы после смены фамилии, могут возникнуть проблемы при трудоустройстве, банковских операциях, поездках за рубеж.",
      "Брак, заключённый при наличии препятствий, может быть признан недействительным."
    ],
    steps: [
      "Для регистрации брака: подайте совместное заявление через Госуслуги или лично в ЗАГС, оплатите госпошлину, получите дату регистрации.",
      "Для смены фамилии при браке: выберите фамилию при подаче заявления — после регистрации изменить будет сложнее.",
      "Для смены фамилии после развода: подайте заявление в ЗАГС о возврате добрачной фамилии — одновременно с разводом или позже отдельно.",
      "Для смены фамилии по желанию: подайте заявление в ЗАГС по месту жительства, оплатите госпошлину, получите свидетельство о перемене имени, затем замените паспорт в МВД.",
      "После замены паспорта: последовательно замените СНИЛС (в СФР), ИНН (в ФНС, если нужно), полис ОМС (в страховой компании), банковские карты.",
      "Для получения дубликата свидетельства: обратитесь в ЗАГС, выдавший документ, или подайте заявление через МФЦ/Госуслуги."
    ],
    documents: [
      "Паспорта обоих заявителей (для регистрации брака)",
      "Свидетельство о расторжении предыдущего брака (если был)",
      "Квитанция об оплате госпошлины",
      "Заявление о перемене имени (для смены фамилии по желанию)",
      "Свидетельство о рождении (при смене фамилии)",
      "Свидетельство о браке или расторжении (при смене фамилии после развода)"
    ],
    mistakes: [
      "Не заменить паспорт в течение 30 дней после смены фамилии — штраф.",
      "Забыть заменить СНИЛС, ИНН, полис ОМС после смены фамилии — могут возникнуть проблемы с выплатами и медпомощью.",
      "Не сообщить работодателю о смене фамилии — нужно подать заявление и внести запись в трудовую книжку.",
      "Думать, что Госуслуги автоматически обновят все документы — нет, каждый нужно менять отдельно."
    ],
    faq: [
      {
        question: "Можно ли зарегистрировать брак быстрее чем через месяц?",
        answer: "Да. При беременности, рождении ребёнка, угрозе жизни одному из заявителей ЗАГС вправе зарегистрировать брак в день подачи заявления или сократить срок."
      },
      {
        question: "Можно ли взять двойную фамилию при браке?",
        answer: "Да, если в результате фамилия не станет более чем двойной. Оба супруга могут взять двойную фамилию или каждый свою."
      },
      {
        question: "Как вернуть девичью фамилию после развода?",
        answer: "При расторжении брака в ЗАГС или суде — указать желание вернуть фамилию в заявлении. После развода — подать отдельное заявление в ЗАГС в любое время."
      },
      {
        question: "Нужно ли согласие второго супруга на смену фамилии?",
        answer: "Нет. Смена фамилии — личное право гражданина. Согласие супруга не требуется ни при браке, ни после его расторжения."
      },
      {
        question: "Что делать, если потеряно свидетельство о браке?",
        answer: "Обратитесь в ЗАГС, который зарегистрировал брак, или подайте заявление через МФЦ/Госуслуги. Дубликат выдаётся платно (госпошлина)."
      },
      {
        question: "Можно ли сменить фамилию ребёнку?",
        answer: "До 14 лет — по заявлению обоих родителей с разрешения органа опеки. После 14 лет — по заявлению самого ребёнка с согласия родителей. После 18 лет — самостоятельно."
      }
    ],
    relatedDocumentSlugs: ["iskovoe-zayavlenie"],
    relatedQuestionTopics: ["регистрация брака", "смена фамилии после замужества", "смена фамилии после развода", "вернуть девичью фамилию", "дубликат свидетельства о браке", "смена фамилии документы"],
    relatedLawyerSpecializations: ["семейное право", "гражданское право"],
    legalReferenceKeys: ["sk_10", "sk_11", "sk_12", "sk_14", "nk_333_26"],
    selfHelpConditions: [
