...
const topProblemOverrides: Record<string, LegalProblemOverride> = {
  ...
  "semya-i-deti/brak-zags-i-smena-familii": {
    ...
    seoTitle: "Брак и ЗАГС — регистрация брака, смена имени, свидетельства и исправление записи",
    seoDescription: "Что делать для регистрации брака, перемены имени, получения повторного свидетельства или справки и исправления записи ЗАГС. Проверенные сроки, госпошлины и документы.",
    riskLevel: "low",
    urgency: "standard",
    heroNote: {
