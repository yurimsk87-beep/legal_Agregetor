...
export const legalProblems: LegalProblem[] = [referenceProblem, DIVORCE_PROPERTY_PROBLEM, GUARDIANSHIP_PROBLEM, PARENTS_CHILD_PROBLEM, CHILD_SUPPORT_PROBLEM, PARENTAL_RIGHTS_DEPRIVATION_PROBLEM, PARENTAL_RIGHTS_RESTRICTION_PROBLEM, PATERNITY_ESTABLISHMENT_PROBLEM, PATERNITY_CONTEST_PROBLEM];

export const popularProblems: LegalProblem[] = [referenceProblem, DIVORCE_PROPERTY_PROBLEM, GUARDIANSHIP_PROBLEM, PARENTS_CHILD_PROBLEM, CHILD_SUPPORT_PROBLEM, PARENTAL_RIGHTS_DEPRIVATION_PROBLEM, PARENTAL_RIGHTS_RESTRICTION_PROBLEM, PATERNITY_ESTABLISHMENT_PROBLEM, PATERNITY_CONTEST_PROBLEM];
